      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View className="flex-1 bg-primary p-5 justify-center">
          ...
          <View className="mb-6">
            ...
            <View
              className={`bg-white rounded-lg flex-row items-center h-12 py-2 border ${
                error && !currentPassword ? "border-red-500" : "border-gray-200"
              }`}
            >
              <TextInput
          ...
          <View className="mb-6">
            ...
            <View
              className={`bg-white rounded-lg flex-row items-center h-12 py-2 border ${
                error && !newPassword ? "border-red-500" : "border-gray-200"
              }`}
            >
              <TextInput
                className="flex-1 px-6 h-12 text-base"
