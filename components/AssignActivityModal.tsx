    ...
    return (
        ...
        >
                ...
                <View className="bg-white p-6 rounded-2xl w-full">
                    ...
                    <Text className="text-3xl font-semibold text-titlegray mb-2">Assign Activity</Text>
                ...
                <ScrollView style={{ height: 400, marginTop: 10 }} contentContainerStyle={{ flexGrow: 1 }}>
                <View>
                    ...
                    filteredActivities.map((activity) => (
                        ...
                        <View>
                            ...
                            <Text className="text-sm text-gray-500">{activity.numQuestions} Questions</Text>
                        </View>
