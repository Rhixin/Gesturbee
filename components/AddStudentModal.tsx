    ...
    >
      <View style={{ backgroundColor: "rgba(0, 0, 0, 0.5)" }} className="flex-1 justify-center items-center px-4">
        <View className="bg-white w-full rounded-2xl p-6">
          <Text className="text-3xl font-semibold text-titlegray mb-2">Invite students</Text>
          <Text className="text-lg text-subtitlegray mb-2">Invite students to join this class! </Text>
          ...
          <View className="mb-4">
            ...
            <View className="flex-row items-center border border-gray-300 rounded-lg p-2">
              ...
              <TouchableOpacity onPress={copyToClipboard}> <Ionicons name="copy-outline"></Ionicons></TouchableOpacity>     
            </View>
          </View>
          ...
          <ScrollView className="max-h-64">
            ...
            >
              ...
              <Text className={`font-medium ${
                selectedStudents.includes(student.id) ? 'text-white' : 'text-gray-500'
              }`}>
                {student.name}
              </Text>
